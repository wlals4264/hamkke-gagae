...
> ⚠️ 현재 `src/data/places.json`의 장소 데이터는 전부 개발용 샘플(mock)입니다. 실제 존재하는 특정 업체 정보가 아니며, 추후 공공데이터(한국관광공사 TourAPI 등)로 교체하는 것을 전제로 설계했습니다.
